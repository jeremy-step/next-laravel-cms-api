...
namespace Illuminate\Database\Query {
     ...
     */        class Builder {
         ...
         * @return \Illuminate\Database\Eloquent\Model 
         * @static 
         */        public static function findOrNotFound($id, $columns = [], $resource = null)
        {
                        return \Illuminate\Database\Query\Builder::findOrNotFound($id, $columns, $resource);
        }
            }
    }
...
namespace Illuminate\Database\Eloquent\Relations {
     ...
     */        class Relation {
         ...
         */        public static function findOrNotFound($id, $columns = [], $resource = null)
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::findOrNotFound($id, $columns, $resource);
        }
            }
            /**
     * 
...
namespace  {
             ...
             */            public static function findOrNotFound($id, $columns = [], $resource = null)
            {
                                return \Illuminate\Database\Eloquent\Builder::findOrNotFound($id, $columns, $resource);
            }
                            /**
